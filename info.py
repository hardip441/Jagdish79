...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5478953362').split()] # For Multiple Id Use One Space Between Each.
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '5478953362').split()]  # For Multiple Id Use One Space Between Each.
...
reqst_channel = environ.get('REQST_CHANNEL', 'https://t.me/+Hp8I2Zqf4NozYmI1')
...
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1003144854316').split()]  # For Multiple Id Use One Space Between Each.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+knjM74efbE1hZGNl')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/MoviesGroupG3')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+gVTXekxU98owZGY1') # Support Chat Link Without https:// or @
...
VERIFY_SHORTLINK_API = environ.get('VERIFY_SHORTLINK_API', 'teraboxlinks.com b6c5b33d5d936b482cea6aed50e073d3139e6ef3')
VERIFY_TUTORIAL = environ.get('VERIFY_TUTORIAL', 'https://t.me/MoviesGroupG3')
